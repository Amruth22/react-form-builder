...
export const parseQuestionId = (questionId) => {
  ...
  if (questionId.startsWith('page_')) {
    ...
    return {
      pageIndex: parseInt(parts[1], 10) - 1, // Convert back to 0-indexed
      sectionIndex: parseInt(parts[3], 10),
      groupIndex: parseInt(parts[5], 10),
      questionIndex: parseInt(parts[7], 10)
    };
  }
  ...
  return {
    ...
    groupIndex: parseInt(parts[3], 10),
    questionIndex: parseInt(parts[4], 10)
  };
};
